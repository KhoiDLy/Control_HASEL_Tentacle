...
// Analog input from the joystick A1, A2
#define potpin1 5
#define potpin2 4
...
InitialValx = analogRead(potpin1); // Calibrating valx to be 0, the valx range is -511 to 511
InitialValy = analogRead(potpin2); // Calibrating valy to be o, the valy range is -511 to 511
//Initialize val1, val2, and val3 ( 256 corresponding to 5V out of the digital pins, which corresponds to 0V High Voltage
}
...
valx = analogRead(potpin1)-InitialValx; // Calibrating valx to be 0, the valx range is -511 to 511
valy = analogRead(potpin2)-InitialValy; // Calibrating valy to be o, the valy range is -511 to 511
